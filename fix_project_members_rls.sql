...
-- Note: If you're still experiencing infinite recursion issues after running this script,
-- you may need to temporarily disable RLS on the project_members table during development:
